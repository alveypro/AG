...
contract UltraSecureWheelGameV6_AllWin is ReentrancyGuard, AccessControl, Pausable {
    // 角色定义
    ...
    // 胜率配置 (优化后 - 50%中奖率)
    uint256 public constant BASE_WIN_RATE = 50;        // 基础胜率50%
    uint256 public constant CONSECUTIVE_LOSS_BONUS = 5; // 连续失败奖励
    uint256 public constant MAX_WIN_RATE = 70;         // 最大胜率70%
    ...
    function _initializeRewardLevels() private {
        ...
        rewardLevels.push(RewardLevel({
            probability: 1,
            maoReward: 10000 * 10**18, // 10000 MAO (100倍)
            piReward: 100000 * 10**18, // 100000 PI (100倍)
            name: "Special Prize"
        }));
        ...
        rewardLevels.push(RewardLevel({
            probability: 5,
            maoReward: 2000 * 10**18,  // 2000 MAO (20倍)
            piReward: 20000 * 10**18,  // 20000 PI (20倍)
            name: "First Prize"
        }));
        ...
        rewardLevels.push(RewardLevel({
            probability: 20,
            maoReward: 500 * 10**18,   // 500 MAO (5倍)
            piReward: 5000 * 10**18,   // 5000 PI (5倍)
            name: "Second Prize"
        }));
        ...
        rewardLevels.push(RewardLevel({
            probability: 50,
            maoReward: 200 * 10**18,   // 200 MAO (2倍)
            piReward: 2000 * 10**18,   // 2000 PI (2倍)
            name: "Third Prize"
        }));
        ...
        rewardLevels.push(RewardLevel({
            probability: 150,
            maoReward: 110 * 10**18,   // 110 MAO (1.1倍)
            piReward: 1100 * 10**18,   // 1100 PI (1.1倍)
            name: "Fourth Prize"
        }));
        ...
        rewardLevels.push(RewardLevel({
            probability: 274,
            maoReward: 101 * 10**18,   // 101 MAO (1.01倍)
            piReward: 1010 * 10**18,   // 1010 PI (1.01倍)
